...
Policy-Regeln:
- export_document muss vor open_preview laufen.
- open_preview muss vor save_as laufen.
- Kein Schritt darf doppelt vorkommen.
...
Get-Content .\out\llm_workflow_sandbox\workflow.kworkflow.json -Raw
