...
.\build_vs\Release\kalyx_host_dispatch_demo.exe --envelope .\out\profile_app.kie.md --response .\examples\app_workflow_valid.kresp.md --validation-audit .\out\profile_validation.kaudit.json --dispatch-audit .\out\profile.kdispatch.json --sandbox-dir .\out\profile_sandbox --provider offline_file --model manual_profile_workflow --temperature 0 --max-tokens 4096
.\build_vs\Release\kalyx_audit_print.exe .\out\profile_validation.kaudit.json
